-- ============================================================
-- Lesson 31-F4
-- Fix booking RPC for current order_appointments schema
--
-- Current appointment architecture:
-- Appointment owns starts_at / ends_at directly.
-- No slot_id dependency.
-- ============================================================
...
begin
  ...
  -- ========================================================
  -- 10. Admin Availability Whitelist
  --
  -- Lock the row so Admin cannot modify it while this
  -- transaction is creating the appointment.
  -- ========================================================
  ...
  if
    v_availability.is_available is not true
  then
    raise exception
      'SLOT_NOT_AVAILABLE';
  end if;
  ...
  -- ========================================================
  -- 11. One Active Appointment Per Workspace
  -- ========================================================
  ...
  --
  -- IMPORTANT:
  -- Current schema does NOT use slot_id.
  --
  -- Existing global exclusion constraint remains the final
  -- protection against concurrent overlapping appointments.
  -- ========================================================
